...
const { FIELD_CANNOT_BE_EMPTY, FIELD_CANNOT_BE_SHORTER, ENUM_CAN_BE_ONE_OF } = require('~/app/consts/errors')
const { COOPERATION, COMMENT, USER } = require('~/app/consts/models')
const {
  enums: { MAIN_ROLE_ENUM }
} = require('~/app/consts/validation')
const { NEW } = require('~/app/consts/notificationTypes')
const cooperationService = require('~/app/services/cooperation')
